...
from Rewe import CMD_HELP, Uputt
from Rewe.ewe import rewe_cmd, edit_or_reply

from . import cmd


@rewe_cmd(pattern="hua$")
async def koc(e):
...
@Rewe.on(events.NewMessage(pattern=r"\.$(.*)", outgoing=True))
async def _(event):
