...
from Rewe import Rewe, CMD_LIST



def rewe_cmd(pattern=None, command=None, **args):
...
def command(**args):
    ...
    def decorator(func):
        ...
        if allow_edited_updates:
            Rewe.add_event_handler(func, events.MessageEdited(**args))
        Rewe.add_event_handler(func, events.NewMessage(**args))
    ...
    def decorator(func):
        ...
        if Rewe:
            if not disable_edited:
                Rewe.add_event_handler(wrapper, events.MessageEdited(**args))
            Rewe.add_event_handler(wrapper, events.NewMessage(**args))
        return wrapper
