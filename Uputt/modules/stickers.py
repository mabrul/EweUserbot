...
from Uputt import bot
from Uputt.iamuput import uputt_cmd, eod, eor
from Uputt.iamuput.misc import animator, create_quotly
from Uputt.database.variable import cek_var, get_var, set_var
...
@uputt_cmd(pattern="(?:tikel|kang)\\s?(.)?")
async def kang(args):
...
@uputt_cmd(pattern="stickers ?([\\s\\S]*)")
