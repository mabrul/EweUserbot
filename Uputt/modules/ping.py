...
from Uputt.iamuput import edit_or_reply, humanbytes, uputt_cmd
...
@uputt_cmd(pattern="ping$")
async def _(ping):
    uptime = await get_readable_time((time.time() - StartTime))
    start = datetime.now()
    Uputt = await edit_or_reply(ping, "**㋱**")
    await Uputt.edit("**㋱㋱**")
    await Uputt.edit("**㋱㋱㋱**")
    await Uputt.edit("**㋱㋱㋱㋱**")
    await Uputt.edit("**㋱㋱㋱㋱㋱**")
