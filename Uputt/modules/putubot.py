...
@uputt_cmd(pattern=r"sadboy(?: |$)(.*)")
async def _(a):
    uputt = await a.edit("`Pertama-tama kamu cantik`")
    sleep(2)
...
@uputt_cmd(pattern=r"lah(?: |$)(.*)")
async def _(y):
    uputt = await y.edit("**Lah, Lu tolol?**")
    sleep(2)
...
@uputt_cmd(pattern=r"sok(?: |$)(.*)")
async def _(i):
    uputt = await i.reply("**WOII**")
    sleep(2)
...
@uputt_cmd(pattern=r"wah(?: |$)(.*)")
async def _(i):
    uputt = await i.edit("**Wahh, War nya keren bang**")
    sleep(2)
...
@uputt_cmd(pattern=r"alay(?: |$)(.*)")
async def _(n):
    uputt = await n.edit("eh kamu, iya kamu")
    sleep(2)
...
@uputt_cmd(pattern=r"erpe(?: |$)(.*)")
async def _(x):
    uputt = await x.edit("Hai, Kamu Anak Erpe Ya")
    sleep(2)
...
@uputt_cmd(pattern=r"tittle(?: |$)(.*)")
async def _(d):
    uputt = await d.edit("**OI ANAK TITLE**")
    sleep(2)
