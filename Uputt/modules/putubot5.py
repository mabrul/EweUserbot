...
@uputt_cmd(pattern=r"ganteng(?: |$)(.*)")
async def _(y):
    uputt = await y.reply("`Lu Mau Tau Sebuah Fakta?`")
    sleep(3)
...
@uputt_cmd(pattern=r"wibu(?: |$)(.*)")
async def _(i):
    uputt = await i.reply("`Kata Emak`")
    sleep(2)
