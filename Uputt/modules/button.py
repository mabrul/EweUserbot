...
from Uputt import CMD_HELP, bot
from Uputt.iamuput import uputt_cmd, edit_delete, reply_id
...
@uputt_cmd(pattern="cbutton(?:\\s|$)([\\s\\S]*)")
async def _(event):
...
@uputt_cmd(pattern="ibutton(?:\\s|$)([\\s\\S]*)")
async def _(event):
    ...
    BOT_USERNAME = UputtUBOT.username
