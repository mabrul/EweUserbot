...
from Uputt.iamuput import uputt_cmd, eor, time_formatter
...
@uputt_cmd(pattern="sleep ([0-9]+)$", allow_sudo=False)
...
@uputt_cmd(pattern="restart$", allow_sudo=False)
