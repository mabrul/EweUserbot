...
from Uputt import Uputt, CMD_HELP
from Uputt.iamuput import uputt_cmd, eod, eor
from Uputt.database.core import db
...
async def terminal_runner(event):
    ...
    if command in ("Uputt.session", "config.env"):
